            ...
            <Main>
                ...
                <ProfilAccount>
                    <ProfilAccountContentWrapper>
                        <ProfilAccountTitle>Argent Bank Checking (x8349)</ProfilAccountTitle>
                        <ProfilAccountAmount>$2,082,79</ProfilAccountAmount>
                        <ProfilAccountAmountDescription>Available Balance</ProfilAccountAmountDescription>
                    </ProfilAccountContentWrapper>
                    <ProfilAccountButtonWrapperCta>
                        <ProfilTransfer>View transactions</ProfilTransfer>
                    </ProfilAccountButtonWrapperCta>
                </ProfilAccount>
                ...
                <ProfilAccount>
                    <ProfilAccountContentWrapper>
                        <ProfilAccountTitle>Argent Bank Credit Card (x8349)</ProfilAccountTitle>
                        <ProfilAccountAmount>$184,30</ProfilAccountAmount>
                        <ProfilAccountAmountDescription>Current Balance</ProfilAccountAmountDescription>
                    </ProfilAccountContentWrapper>
                    <ProfilAccountButtonWrapperCta>
                        <ProfilTransfer>View transactions</ProfilTransfer>
                    </ProfilAccountButtonWrapperCta>
...
const ProfilAccountButtonWrapperCta = styled.button`
display: block;
width: 100%;
padding: 8px;
font-size: 1.1rem;
